...
import OpenAPIRestAPI, { Verifier } from '../../library/src/openapi/RestAPI'
import OpenAPIBasicModels from '../../library/src/openapi/BasicModels'
...
export class ApiStack extends cdk.Stack {
  constructor (scope: Construct, id: string, props: cdk.StackProps, config: StackParameters) {
    ...
    // Create API Gateway
    const apiGateway = new OpenAPIRestAPI<Resources>(this, 'Test API', {
      Description: 'Test API - https://github.com/connected-web/openapi-rest-api',
      SubDomain: 'test-api',
